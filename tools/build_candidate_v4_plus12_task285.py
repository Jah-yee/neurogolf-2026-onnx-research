...
ANCHOR = ROOT / "submissions/candidate_v4_plus11_compiler3_onnx"
TASK285_V2 = ROOT / "submissions/handbuilds/task285_v2.onnx"
OUTPUT = ROOT / "submissions/candidate_v4_plus12_task285_onnx"
ZIP_PATH = ROOT / "submissions/submission_candidate_v4_plus12_task285.zip"
MANIFEST = ROOT / "reports/candidate_v4_plus12_task285_manifest.csv"
SUMMARY = ROOT / "reports/candidate_v4_plus12_task285_build.json"

CHANGED_TASK = "task285"
...
def main() -> None:
    ...
    if not TASK285_V2.exists():
        raise RuntimeError(f"missing task285 overlay: {TASK285_V2}")

    if args.output.exists():
        shutil.rmtree(args.output)
    shutil.copytree(ANCHOR, args.output)
    shutil.copy2(TASK285_V2, args.output / "task285.onnx")
    ...
    summary = {
        ...
        "task285_overlay": str(TASK285_V2.relative_to(ROOT)),
