"""DSL v3 depth-≤2 search runner (23 primitives: 18 base + 5 Hodel-inspired).
"""
...
def main() -> None:
    ...
    p.add_argument("--out-csv", default=str(ROOT / "reports/dsl_v3_search_results.csv"))
    p.add_argument("--swap-csv", default=str(ROOT / "reports/dsl_v3_swap_candidates.csv"))
    p.add_argument("--out-dir", default=str(ROOT / "submissions/handbuilds/dsl_v3"))
