...
ANCHOR = ROOT / "submissions/candidate_v4_plus9_compiler_onnx"
COMPILER_V2 = ROOT / "submissions/compiler_golf_probe_v2_onnx"
OUTPUT = ROOT / "submissions/candidate_v4_plus10_compiler2_onnx"
ZIP_PATH = ROOT / "submissions/submission_candidate_v4_plus10_compiler2.zip"
MANIFEST = ROOT / "reports/candidate_v4_plus10_compiler2_manifest.csv"
SUMMARY = ROOT / "reports/candidate_v4_plus10_compiler2_build.json"

COMPILER_V2_TASKS = (92, 138, 191, 192, 205, 209, 215, 376, 377, 396)
...
def main() -> None:
    args = parse_args()
    for source in (ANCHOR, COMPILER_V2):
    ...
    for task_id in COMPILER_V2_TASKS:
        shutil.copy2(COMPILER_V2 / f"task{task_id:03d}.onnx", args.output)
    ...
    expected = {f"task{task_id:03d}" for task_id in COMPILER_V2_TASKS}
